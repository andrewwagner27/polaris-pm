  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/maintenance" element={<ProtectedTenantRoute><MaintenanceScreen/></ProtectedTenantRoute>}/>
        <Route path="/maintenance/:id" element={<ProtectedTenantRoute><MaintenanceDetail/></ProtectedTenantRoute>}/>
        ...
        <Route path="/landlord/maintenance/:id" element={<ProtectedLandlordRoute><LandlordMaintenanceDetail/></ProtectedLandlordRoute>}/>
